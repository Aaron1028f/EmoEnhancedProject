...
def main():
    ...
    for actor_id in ACTOR_ID_LIST:
        for emo_id in EMOTION_ID_LIST:
            ...
            # calculate AU std
            emogene_AU_std = emogene_prediction.aus.std()
            genefacepp_AU_std = genefacepp_prediction.aus.std()
            
            # calcuate AU max (peak)
            emogene_AU_max = emogene_prediction.aus.max()
            genefacepp_AU_max = genefacepp_prediction.aus.max()
