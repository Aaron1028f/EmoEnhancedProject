...
class SECC_Renderer(nn.Module):
    def __init__(self, rasterize_size=None, device="cuda"):
        super().__init__() # face model
        # super(SECC_Renderer, self).__init__()
        # super().__init__() means that the subclass is calling the __init__ method of the superclass.
        # superclass is nn.Module, and the __init__ method of nn.Module is called.
        
        # rasterize_size: the size of the rendered image, default is 2*center of face model
